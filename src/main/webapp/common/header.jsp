...
<head>
    ...
    <link rel="stylesheet" href="<%=CONTEXT%>/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="<%=CONTEXT%>/css/themify-icons.css" type="text/css">
    <link rel="stylesheet" href="<%=CONTEXT%>/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="<%=CONTEXT%>/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="<%=CONTEXT%>/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="<%=CONTEXT%>/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="<%=CONTEXT%>/css/slicknav.min.css" type="text/css">
